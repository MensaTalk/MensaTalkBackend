...
INSERT INTO app_user (app_user_id, username, password, age, interests, status, amazon_url) values ('1','dummyUser','pw','26','Sports, Coding, Food','Whats up ppl??', '-');
INSERT INTO app_user (app_user_id, username, password, age, interests, status, amazon_url) values ('999','abteilung6','abteilung6','26','Sports, Coding, Food','Whats up ppl??','-');
